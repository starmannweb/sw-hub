            ...
            <div className="flex flex-col h-screen w-full overflow-hidden bg-[#16161a] text-[#b4b4c0] font-sans selection:bg-[#8b5cf6]/30">
                ...
                <div className="h-14 shrink-0 bg-[#16161a] border-b border-[#232329] flex items-center justify-between px-3 z-30">
                    ...
                    <div className="flex items-center gap-1 w-1/3">
                        <div className="flex items-center justify-center w-10 h-10 mr-2 text-[#8b5cf6] font-extrabold text-2xl italic">
                            R
                        </div>
                    ...
                    <div className="flex items-center justify-end gap-2 w-1/3">
                        ...
                        <button className="px-6 py-2 ml-2 rounded-xl bg-[#232329] hover:bg-[#2e2e36] text-[#e4e4e7] text-[13px] font-medium transition-colors border border-[#31313a]">
                            Publicar
                        </button>
                    </div>
                </div>
